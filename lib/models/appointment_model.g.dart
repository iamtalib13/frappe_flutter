...
const AppointmentSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'syncStatus': PropertySchema(
      ...
      name: r'syncStatus',
      type: IsarType.string,
      enumMap: _AppointmentsyncStatusEnumValueMap,
    )
  },
...
Appointment _appointmentDeserialize(
  ...
  object.syncStatus =
      _AppointmentsyncStatusValueEnumMap[reader.readStringOrNull(offsets[5])] ??
          SyncStatus.synced;
  return object;
}
...
P _appointmentDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 4:
      return (reader.readStringOrNull(offset)) as P;
    case 5:
      return (_AppointmentsyncStatusValueEnumMap[
...
const _AppointmentsyncStatusEnumValueMap = {
  r'synced': r'synced',
  r'pending': r'pending',
  r'failed': r'failed',
};
const _AppointmentsyncStatusValueEnumMap = {
...
extension AppointmentQueryFilter
  ...
  QueryBuilder<Appointment, Appointment, QAfterFilterCondition> nameIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'name',
      ));
  ...
  QueryBuilder<Appointment, Appointment, QAfterFilterCondition> nameEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Appointment, Appointment, QAfterFilterCondition> nameGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Appointment, Appointment, QAfterFilterCondition> nameLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Appointment, Appointment, QAfterFilterCondition> nameBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Appointment, Appointment, QAfterFilterCondition> nameStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Appointment, Appointment, QAfterFilterCondition> nameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Appointment, Appointment, QAfterFilterCondition> nameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Appointment, Appointment, QAfterFilterCondition> nameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Appointment, Appointment, QAfterFilterCondition> nameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'name',
        value: '',
...
extension AppointmentQuerySortBy
  ...
  QueryBuilder<Appointment, Appointment, QAfterSortBy> sortByCustomerName() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Appointment, Appointment, QAfterSortBy> sortByLastModified() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Appointment, Appointment, QAfterSortBy> sortByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<Appointment, Appointment, QAfterSortBy> sortByNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.desc);
    });
  }

  QueryBuilder<Appointment, Appointment, QAfterSortBy> sortByScheduledTime() {
    return QueryBuilder.apply(this, (query) {
...
extension AppointmentQuerySortThenBy
  ...
  QueryBuilder<Appointment, Appointment, QAfterSortBy> thenByCustomerName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'customerName', Sort.asc);
    });
  }
  ...
  QueryBuilder<Appointment, Appointment, QAfterSortBy> thenByLastModified() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastModified', Sort.asc);
    });
  }
  ...
  QueryBuilder<Appointment, Appointment, QAfterSortBy> thenByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<Appointment, Appointment, QAfterSortBy> thenByNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.desc);
    });
  }

  QueryBuilder<Appointment, Appointment, QAfterSortBy> thenByScheduledTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'scheduledTime', Sort.asc);
    });
  }
...
extension AppointmentQueryWhereDistinct
  ...
  QueryBuilder<Appointment, Appointment, QDistinct> distinctByCustomerName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Appointment, Appointment, QDistinct> distinctByLastModified() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'lastModified');
    });
  }

  QueryBuilder<Appointment, Appointment, QDistinct> distinctByName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Appointment, Appointment, QDistinct> distinctByScheduledTime() {
    return QueryBuilder.apply(this, (query) {
...
extension AppointmentQueryProperty
  ...
  QueryBuilder<Appointment, String, QQueryOperations> customerNameProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Appointment, String?, QQueryOperations> nameProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Appointment, SyncStatus, QQueryOperations> syncStatusProperty() {
    return QueryBuilder.apply(this, (query) {
